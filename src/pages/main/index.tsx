...
import { Canvas } from "@react-three/fiber"; //--do renderowania sceny
import { Box, KeyboardControls, OrbitControls } from "@react-three/drei"; 
import { Physics, RigidBody } from "@react-three/rapier"; // fizyka, kolizje
import Ecctr, { EcctrlJoystick } from "ecctrl";
import { useStore } from "../../lib/store";
import { Img, Room } from "../../components/scene";

//obrazy i ich przypisane tytuły
const obrazyOpisy = {
...
// Mapa klawiatury definiująca sterowanie
const keyboardMap = [
...
// Modal z informacjami o wybranym obrazie
...
// Główna komponenta aplikacji
export function Main() {
  const store = useStore(); // Dostęp do stanu aplikacji
  const [selected, setSelected] = useState<string | undefined | null>(null); // Stan dla modalu z obrazem

  return (
    <div className="w-screen h-screen">
      {/* Modal dla wybranego obrazu */}
      {selected && (
        <ArtModal
          selected={selected}
      ...
      {/* Joystick dla urządzeń mobilnych */}
